...
- `boards/arm/bifrost_left/`: Left board definition and central-side settings.
- `boards/arm/bifrost_right/`: Right board definition, peripheral-side settings,
...
The physical layout is defined in `boards/arm/bifrost-layouts.dtsi`. Studio
